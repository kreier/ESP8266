# I2C scanner with SH1106 OLED display output

That's how the setup looks like:

![setup](i2c_scanner_picture.jpeg)

And that's the serial output:

![output](SH1106_i2c-scan.png)
